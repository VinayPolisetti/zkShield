...
contract ZKWorth is Ownable {
    ...
    struct User {
        uint256 publicKey; // Basically, holds only the index in publickeys array at which our public key is present
    ...
    mapping(string => User) internal accounts; // from username to User
    ...
    function setRequests( // Whats id here like senderid and receiverid
        string calldata _sender,
